package com.tamnguyen.ttdavidrnxprinter;
  ...
  public void connectPrinter(String bleAddress, final Promise promise) {
    binder.connectBtPort(bleAddress, new UiExecute() {
      ...
      public void onsucess() {
        ...
        // in this ,you could call acceptdatafromprinter(),when disconnect ,will execute
        // onfailed();
        // binder.write(DataForSendToPrinterPos80.openOrCloseAutoReturnPrintState(0x1f),
        // new UiExecute() {
        // @Override
        // public void onsucess() {
